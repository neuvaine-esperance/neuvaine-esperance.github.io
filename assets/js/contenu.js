...
window.NEUVAINE_CONTENU = {
  ...
  7: {
    ...
    // La machine n'a entendu qu'un mot au début du chant, « Seigneur », et
    // lui a donné neuf secondes ; le premier appui sûr ne vient qu'à 246,46 s,
    // sur « Tu me tiens dans tes mains ». Les dix mots du début s'étalaient
    // donc à 2,01 seconde chacun, juste au-dessus de PAS_MAX, et restaient
    // éteints : après la méditation, le chant ne prenait jamais la main.
    //
    // Où la voix entre exactement, on ne le sait pas : le chant s'ouvre sur
    // une montée de trente décibels, et les mesures de timbre essayées ici
    // ne séparent pas le chanté de l'instrumental — leurs témoins pris sur du
    // chant certain donnent les mêmes valeurs que l'introduction. Plutôt que
    // de laisser le bloc mort, le texte suit donc dès le début du chant.
    reperes: [
      [0, 217.3]   // « Seigneur je t’aime », dès le début du chant
    ],
    audio: 'assets/audio/jour-7.mp3?v=3',
    sync: 'assets/audio/jour-7.sync.js?v=5',
  ...
  9: {
    ...
    sync: 'assets/audio/jour-9.sync.js?v=5',
